...
public class ForMission : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        list.Add(new TextPartition("Our game will start by asking a question, and the person who answers correctly will get a chance to score. The first person to reach 3 points wins!", ""));
