...
public class FirstPersonController : MonoBehaviour
{
    ...
    private GameObject touchedBox; // נשתמש בזה כדי לשמור את הקובייה שנגענו בה באופן דינמי
    ...
    private bool isTouchingBox = false; // משתנה לסטטוס של מגע בקופסה
