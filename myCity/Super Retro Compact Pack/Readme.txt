...
Thank you for buying this model.
...
-----------------------------
The cars come with a default license plate, but you can change that by editing the texture map. If you need to create a lot of different license plates, you can create a new texture file and separate the license plate polygon to a new material.
